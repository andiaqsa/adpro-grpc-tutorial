        ...
        tokio::spawn(async move {
            for i in 0..30 { // Simulasi mengirim 30 record transaksi
                if tx.send(Ok(TransactionResponse {
                    ...
                    break; // Berhenti jika client terputus
                }

                // Beri jeda 1 detik setiap kelipatan 10 data
                if i % 10 == 9 {
